...
package com.whoeveryou.FlameWekaCluster;
 ...
 * @version $Revision$
 */
public class WekaClusteringDemo {
  /**
   * Run clusterers
   *
   * @param filename      the name of the ARFF file to run on
   */
  public WekaClusteringDemo(String filename) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 1) {
      System.out.println("usage: " + WekaClusteringDemo.class.getName() + " <arff-file>");
      System.exit(1);
    }

    new WekaClusteringDemo(args[0]);
  }
}
