...
public class WekaClassifierDemo {
  ...
  public static String usage() {
    return "\nusage:\n  " + WekaClassifierDemo.class.getName()
  ...
  public static void main(String[] args) throws Exception {
    WekaClassifierDemo demo;

    if (args.length < 6) {
      System.out.println(WekaClassifierDemo.usage());
      System.exit(1);
    }
